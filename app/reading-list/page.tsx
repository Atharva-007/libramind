                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-xl text-muted-foreground">
                            Discover your next great read from our curated collection ({books.length} books available)
                        </p>
                    </div>
                                ...
                                <CardContent className="p-6 flex-1">
                                    ...
                                    <div className="aspect-[3/4] mb-4 relative overflow-hidden rounded-lg bg-muted">
                                        ...
                                        {user && (
                                            ...
                                            >
                                                {userBookmarks.includes(book.id) ? '❤️' : '🤍'}
                                            </Button>
                                        )}
                                    </div>
                        ...
                        <Card className="mt-8">
                            <CardContent className="p-8 text-center">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    Sign in to bookmark books, track reading progress, and join reading challenges!
                                </p>
